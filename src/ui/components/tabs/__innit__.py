"""
Onglets spécialisés Treasury Dashboard
Modules d'interface pour chaque fonctionnalité métier
"""
...
from .visuals_tab import render_visuals_3d_tab, render_heatmaps_tab
